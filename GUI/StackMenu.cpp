...
/*                                                             #          dahala_m          #   */
/*  created: 07/18/19 15:23:23 by Dahalani Mouhamad            #          bachir_c          #   */
/*  updated: 07/18/19 16:03:19 by Dahalani Mouhamad            #                            #   */
/*                                                             ##############################   */
/*                                                                                              */
/* **********************************************************²***********************************/
...
namespace gui {
    ...
    StackMenu::StackMenu(const sf::Vector2f &position)
            : m_basePosition(position), m_baseSize(300, 20) {
    ...
    StackMenu::StackMenu(StackMenu &&other)
            : m_widgets(std::move(other.m_widgets)),
              ...
              m_basePosition(other.m_basePosition), m_baseSize(other.m_baseSize) {}
