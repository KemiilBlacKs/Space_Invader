...
/*                                                             #          dahala_m          #   */
/*  created: 07/18/19 14:53:36 by Dahalani Mouhamad            #          bachir_c          #   */
/*  updated: 07/22/19 09:50:54 by Dahalani Mouhamad            #                            #   */
/*                                                             ##############################   */
/*                                                                                              */
/* **********************************************************²***********************************/
#include <fstream>
...
namespace SpaceInvaders {
    namespace {
        const auto scoresPath = "../Ressources/score.txt";
    }
    ...
    void StateHighscores::initViewMenu() {
        ...
        backBtn->setText("Menu Principal");
    ...
    void StateHighscores::initSubmitMenu() {
        ...
        nameTextBox->setLabel("Clickez sur la zone pour entrer votre nom");
        ...
        auto backBtn = gui::makeButton();
        backBtn->setText("Voir les meilleurs scores");
        backBtn->setFunction([&]() {
            loadScores();
            switchToViewMenu();
        });
    ...
    void StateHighscores::createHighscoreView() {
        ...
        for (unsigned i = 0; i < m_scores.size(); i++) {
            ...
            if (i >= 9)
                return; // N'affiche que les 10 meilleurs scores
        }
    }
